...
export class LegalInformationComponent implements OnInit {
  ...
  public novosibDocs: object[] = [
    ...
    {
      name: 'Договор оферты',
      file: 'assets/files/Приложение №1 к приказу ПУБЛИЧНАЯ ОФЕРТА.docx',
    },
    {
      name: 'Приказ № 618 от 23.08.2021',
      file: 'assets/files/Приказ № 618 от 23.08.2021_публичная оферта.pdf',
    },
    {
      name: 'Согласие пациента на обработку персональных данных',
      file: 'assets/files/Согласие_пациента_на_обработку_персональных_данных_шаблон с ЕМИАС-2.docx',
    },
    {
      name: 'Лицензия на медицинскую деятельность',
